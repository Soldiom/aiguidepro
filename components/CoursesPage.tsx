                ...
                <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-2xl p-6 border border-emerald-500/20 text-center">
                  {selectedCourse.status === 'متاح' ? (
                    <>
                      ...
                      <a href="/vote" className="inline-block bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-emerald-500/50 transition-all">
                        ابدأ الدورة الآن 🚀
                      </a>
                    </>
                  ) : (
