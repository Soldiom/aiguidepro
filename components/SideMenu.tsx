            ...
            <nav>
                <ul className="space-y-4">
                    ...
                    <li>
                        <NavLink
                            to="/ai-map"
                            className={({ isActive }) => `flex items-center px-4 py-3 text-lg rounded-lg transition-colors duration-200 ${isActive ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold' : 'text-slate-300 hover:bg-slate-700 hover:text-white'}`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
