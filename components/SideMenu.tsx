                ...
                <ul className="space-y-4">
                    ...
                    <li>
                        <a
                            ...
                            className="flex items-center px-4 py-3 text-lg rounded-lg transition-colors duration-200 text-slate-300 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-teal-600 hover:text-white"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
